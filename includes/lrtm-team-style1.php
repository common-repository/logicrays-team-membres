<?php
add_shortcode( 'LRTM-STYLE1', 'lergs_shortcode_style1' );
function lergs_shortcode_style1() {
ob_start();
?>
<div class="row">
      <?php
    ...
    <div class="col-md-<?php echo $lrtm_grid_layout['lrtm_grid_layout']; ?>">
      <div class="our-team">
        <div class="pic"><img src="<?php echo $featured_img_url;?>">
